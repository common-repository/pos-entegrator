...
class GPOS_Paratika extends GPOS_Gateway {
	...
	public function get_save_message() {
		return array(
			'type'    => 'warning',
			'message' => __( 'Your account information has been saved. In order to view the payments you have received via POS Integrator, you need to open the “Transaction Inquiry” authorization from the Paratika panel or from your user permissions by contacting Paratika.', 'gurmepos' ),
		);
	}
}
